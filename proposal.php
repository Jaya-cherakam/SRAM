    ...
    <nav class="navbar navbar-default header_aera" id="main_navbar">
        ...
        <ul id="sidebar_menu" class="sidebar-nav">
          ...
          <ul class="sidebar-nav" id="sidebar">
            ...
            <li><a href="proposal.php" style="color: orange;"><b>PROPOSAL</a></b></li>
...
<div class="sidenav">
  <button class="dropdown-btn" style="font-size: 14px;"><b>DURGAMAHALAKSHMI PRODUCTS</b>
  </button>
...
for (i = 0; i < dropdown.length; i++) {
  ...
  dropdownContent.style.display = "block";
        ...
        <div class="slider_inner">
            <div data-thumb="images/3SRAM/product.jpeg" data-src="images/3SRAM/product.jpeg">
                <div class="camera_caption">
                   <div class="container">
                        <h1 class=" wow fadeInUp animated">PROPOSAL</h1>
    ...
    <div class="column">
    <iframe src="http://www.kubota.co.in/proposal/index.html" style="width:91.7%;margin-left: 8.3%; height: 1200px;"></iframe>  
    </div>
