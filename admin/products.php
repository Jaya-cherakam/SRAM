       ...
       <!-- Sidebar -->
        ...
        <ul id="sidebar_menu" class="sidebar-nav">
          ...
          <ul class="sidebar-nav" id="sidebar">
            ...
            <li><a href="products.php" style="color: orange;"><b>PRODUCTS</a></b></li>
   ...
   <!-- End Header_Area -->
    ...
    <section class="slider_area row m0" >
        <div class="slider_inner">
            <div data-thumb="images/3SRAM/aboutkubota1.png" data-src="images/3SRAM/aboutkubota1.png">
                <div class="camera_caption">
                   <div class="container">
                        <h1 class=" wow fadeInUp animated" style="font-size: 40px;">ABOUT PRODUCTS</h1>
            ...
            <div data-thumb="images/3SRAM/aboutkubota1.png" data-src="images/3SRAM/aboutkubota1.png">
                <div class="camera_caption">
                   <div class="container">
                        <h1 class=" wow fadeInUp animated" style="font-size: 40px;">KUBOTA PRODUCTS</h1>
                        <h6 class=" wow fadeInUp animated" data-wow-delay="0.5s"></h6>
                        <p class=" wow fadeInUp animated" data-wow-delay="0.8s"></p>
                   </div>
                </div>
    ...
    <div class="column">
    <iframe src="http://www.kubota.co.in/products/index.html" style="width:91.7%;height: 1200px;margin-left: 8.3%;"></iframe>  
    </div>
