  ...
  dropdownContent.style.display = "block";
            ...
            <div class="col-md-4 p0">
                <div class="navbar-header">
                    ...
                    <img src="images/sram1.jpeg" style="height: 100% border-radius:40%;">
                    </div>
            </div>
            ...
            <div class="col-md-8 p0">
                <div class="collapse navbar-collapse" id="min_navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="product.php" style="color: orange;">Products</a></li>
    ...
    <section class="slider_area row m0" >
        <div class="slider_inner">
            <div data-thumb="images/3SRAM/product.jpeg" data-src="images/3SRAM/product.jpeg">
                <div class="camera_caption">
                   <div class="container">
                        <h1 class=" wow fadeInUp animated" style="color:white;font-size: 40px;">PRODUCTS</h1>
    ...
    <!-- Our Services Area -->
    <div class="col-md-10 p0" style="margin-left: 10%;">
    <section class="our_services_area" style="background-color: white;">
            <div class="portfolio_inner_area">
                <div class="portfolio_filter">
                    ...
                    ?>
                     <li data-filter="*" class="active"><?php echo "<a href='product.php?vehicleType=".$vehicleType."'".">".$vehicleType."</a> ";?>
                     </li>
                      <?php }?>
                       </ul>
                </div>
...
if (isset($_GET["vehicleType"])) {
 ...
 $sql = "SELECT DISTINCT vehicleModel,imagePath,demoPath,youtubePath,brochurePath FROM vehicleModels where  vehicleType='$vehicleType' and vehicleModel!='NA' and imagePath!='NA' and demoPath!='NA' and brochurePath!='NA' and youtubePath!='NA' ";
            ...
            <?php 
                ...
                <div class="col-md-4 col-sm-6"> 
                    <div class="renovation">
                        <div class="renovation_content" style="height: 400px;">
                            <img style="height: 250px;" src="<?php echo $row['imagePath']?>"><br>

                            <a class="tittle" href="#"><?php echo $row['vehicleModel'];?></a><br>

                            <a class="clipboard" download href="<?php echo $row['brochurePath']?>"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: black;font-size: 20px;"></i></a>

                            <a class="clipboard" style="left: 20%;" href="<?php echo $row['youtubePath'];?>" target="_blank"><i class="fa fa-youtube-play" style="color: red;"></i></a>

                            <a class="clipboard" style="color: black;margin-left: 35%;" href="<?php echo $row['demoPath'];?>" target="_blank">Demo</a>
                        </div>
                    </div> 
                </div>
                <?php }?>
