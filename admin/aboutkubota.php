       ...
       <!-- Sidebar -->
        ...
        <ul id="sidebar_menu" class="sidebar-nav">
          ...
          <ul class="sidebar-nav" id="sidebar">
            <li><a href="aboutkubota.php" style="color: orange;"><b>ABOUT KUBOTA</b></a></li>
...
for (i = 0; i < dropdown.length; i++) {
  ...
  dropdownContent.style.display = "block";
   ...
   <!-- End Header_Area -->
        ...
        <div class="slider_inner">
            <div data-thumb="images/3SRAM/aboutkubota1.png" data-src="images/3SRAM/aboutkubota1.png">
                <div class="camera_caption">
                   <div class="container">
                        <h1 class=" wow fadeInUp animated" style="font-size: 40px;">ABOUT KUBOTA</h1>
    ...
    <div class="column">
    <iframe src="https://www.kubota.co.in/discover/who-we-are/index.html" style="width:91.7%;height: 1200px;margin-left: 8.3%;"></iframe>  
    </div>
