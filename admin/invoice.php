...
<div class="header" id="myHeader">
  <button  style="width:20%;height: 40px;margin-right: 50%;
    ...
    <button class="span1" onclick="window.location.href='durgaquotationinvoice.php'" style="color:black;">Durga Mahalakshmi Products</button>
  </div>

<img src="3SRAM/uploadapp.png" style="width: 88.4%;margin-left: 5.8%;margin-top: 3%; border-radius: 0px;">
