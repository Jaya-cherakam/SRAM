...
<section id="register_div" style="padding:10%;">
 <form action="server.php" method="post">
  <br>
  <p><input name="username" required="required" type="text" placeholder="Name"/></p><br>
  <p><input name="phone" required="required" type="text" placeholder="Phone" maxlength="10" pattern="[6-9]{1}[0-9]{9}"/></p><br>
  ...
  <p><input type="submit" name="dcustomer_reg" value="Submit"/></p>  
 </form>
</section>
</div>
