...
$result=mysqli_query($con,"SELECT * FROM employeeVehicles")or die('error');
?>
...
<title>EmplopyeeVehicle list</title>
...
<div class="header" id="myHeader">
  <button  style="width:20%;height: 40px;margin-right: 50%;
    ...
    <button class="span1" onclick="window.location.href='empvehicle.php'" style="color:#1097A1;">Manage Employee Vehicle</button>
  </div>
...
<div class="container-fluid" style="height:0px;">
  <button  style="width:10%;height: 40px;margin-right: 50%;
    ...
    font-size: 16px;
    margin-left: 15%;
    border: 1px solid lightgray;" onclick="window.location.href='empvehicle.php'">New Register</button>
    <button class="span" onclick="window.location.href='emplist.php'" style="color:#1097A1;">List</button>
  </div>
...
<div class="container">
  ...
  <thead style="background-color:#1097A1;"> 
            <tr style="color: white;">
                ...
                <th>VehicleType-VehicleModel</th>
                <th>EmployeeName</th>
        ...
        <tbody>
          <?php while($row=mysqli_fetch_array($result)) { ?>
            <tr style="background-color: white;">
                 ...
                 <td><?php echo $row['vehicleType'].'-'.$row['vehicleModel']?></td>
               <?php 
                $emp=$row['empId'];
               $res1=mysqli_query($con,"SELECT * FROM employeeTable where empId='$emp'")or die('error');
                 while($row2=mysqli_fetch_array($res1)) {
               ?>

                 <td><?php echo $row2['empId'].$row2['name']?></td>
               <?php }?>
                 <td>
             
              <a class=btn2 href="empvehicleupdate.php?edit=<?php echo $row['vehicleId'];?>"><i class="fa fa-eye" style="font-size: 13px;height: 20px;top: 2px;right: 3px;">Update</i></a>
              <button type="button" class="btn3" onClick="deleteme(<?php echo $row['vehicleId']; ?>)" value="Delete"><i class="fa fa-trash-o" style="font-size: 13px;height: 20px;top: 2px;">Delete</i></button>
            ...
            <script language="javascript">
              ...
              window.location.href='server.php?del_empvehicle=' +delid+'';
              return true;
              }
              } 
            </script>
