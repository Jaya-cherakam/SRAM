...
<div class="header" id="myHeader">
  <button  style="width:20%;height: 40px;margin-right: 50%;
    ...
    <button class="span1" onclick="window.location.href='sdurgarequest.php'" style="color:#1097A1;">Durga Mahalakshmi Quotations</button>
  </div>
...
<div class="container-fluid" style="height:0px;">
  <button  style="width:10%;height: 40px;margin-right: 50%;
    ...
    font-size: 16px;
    margin-left: 15%;
    border: 1px solid lightgray;" onclick="window.location.href='sdurgarequest.php'">Requests</button>
    <button class="span" onclick="window.location.href='sdurgaresponse.php'" style="color:black;">Responded</button>
  </div>

  <div class="container" style="margin-top: 8%;">
       <?php 
          include 'dbconfig.php';  
          $res=mysqli_query($con,"SELECT *from quotation where status='pending' and productType='durgamahalakshmi'");
         ?> 
  <div class="row">
    <div class="col-lg-12">
     <table id="example" class="table table-striped table-bordered" style="width:100%;">
        ...
        <?php while($row=mysqli_fetch_array($res)):?>
            <tr style="background-color: white;">
              ...
              <td>
                <a class=btn1 href="invoice.php?edit=<?php echo $row['quoteId'];?>">Reply</a>
