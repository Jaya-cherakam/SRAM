...
<div class="container" style="margin-top: 7%;">
  <h2 align="center" style="color: #1097A1;">Customer Update</h2>
  <form action="server.php" method="post">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Username" name="name" placeholder="User name" value="<?php echo $row['name']?>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Phone" name="phone" placeholder="Phone" value="<?php echo $row['mobileNumber']?>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="Aadhaar" name="adhaar" placeholder="Aadhaar" value="<?php echo$row['aadhar']?>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="User Name" name="username" placeholder="User Name" value="<?php echo $row['username']?>">
      </div>
    </div> 
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="Password" name="password" placeholder="Password" value="<?php echo $row['password']?>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="Password">Select User Type:</label>
                            ...
                            <p>
                                <input type="radio" value="active" name="active" <?php if($row['activeStatus']=='active') {echo "checked";}?>>
                                <label for="Active">Active</label>
                            
                                <input type="radio"  value="inactive" name="active" <?php if($row['activeStatus']=='inactive') {echo "checked";}?>>
    ...
    <div class="row">
      ...
      <div class="col-75">
       <input type="text" id="city" name="city" placeholder="city" value="<?php echo $row1['city']?>"> 
      </div>
    </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Current Address" name="currentAddress" placeholder="Current Address" value="<?php echo $row1['currentAddress']?>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="Permanant Address" name="permanentAddress" placeholder="Permanant Address" value="<?php echo $row1['permanentAddress']?>">
      </div>
    </div><br>
    <?php }}?>
    <button type="submit" id="btnSearch" class="btn btn-primary btn-md center-block" name="customer_update" Style="width: 100px;background-color:#1097A1;border-style:none;" OnClick="btnSearch_Click" value="Update">Update</button>
  </form></div>
</body>
</html>
<?php }}else{
