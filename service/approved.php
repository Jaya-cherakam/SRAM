...
$result=mysqli_query($con,"SELECT * FROM customerComplaint where approveStatus='approved'") or die('error');
...
<button class="box" onclick="window.location.href='requested.php'" style="color: black;">Requested</button>
<button class="box" style="margin-left: 50%;color:#1097A1;" onclick="window.location.href='approved.php'">Approved</button>
            ...
            <tr style="background-color: white;">
             ...
             <td><?php echo $row['title']?></td>
               ...
               <?php }}?>
                 ...
                 <td><img src="<?php echo $row['imagePath']?>" width="200" height="200">
                 </td>
              <td> 
              <a class=btn2 href="assigntask.php?edit=<?php echo $row['complaintId']?>">Assign</a> 
              </td>
            </tr>
            <?php }?> 
            </tbody>
