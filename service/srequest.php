...
<div class="container-fluid" style="height:0px;">
  <button  style="width:10%;height: 40px;margin-right: 50%;
    ...
    <button class="span" onclick="window.location.href='sresponse.php'" style="color:black;">Responded</button>
  </div>

  <div class="container">
       <?php 
          include 'dbconfig.php';  
          $res=mysqli_query($con,"SELECT *from quotation where status='pending' and productType='sram'");
         ?> 
     ...
     <table id="example" class="table table-striped table-bordered" style="width:100%;">
        ...
        <?php while($row=mysqli_fetch_array($res)):?>
            <tr style="background-color: white;">
              ...
              <td>
                <a class="btn1" href="invoice.php">Reply</a>
