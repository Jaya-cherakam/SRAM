...
<div class="container-fluid" style="height:0px;">
  <button  style="width:10%;height: 40px;margin-right: 50%;
    ...
    <button class="span" onclick="window.location.href='sdurgaresponse.php'" style="color:#1097A1;">Responded</button>
  </div>

    <div class="container">
       <?php 
          include 'dbconfig.php';  
          $res=mysqli_query($con,"SELECT * from quotation where status='Responded' and productType='durgamahalakshmi'");
         ?> 
