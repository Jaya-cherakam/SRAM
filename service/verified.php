...
$result=mysqli_query($con,"SELECT * FROM taskDetails where status='verified'")or die('error');?>
...
<button class="box" onclick="window.location.href='verified.php'" style="color: #1097A1;">Verified</button>
    ...
    <div class="row" style="margin-left: 10%;">
     <table id="example" class="table table-striped table-bordered" style="width:100%;">
        ...
        <?php while($row=mysqli_fetch_array($result)) { ?>
            ...
            <a class="btn btn-primary btn-md center-block" style="width: 90px;background-color:#1097A1;border-style: none;position:absolute;" href="taskview.php?edit=<?php echo $row['taskId'];?>"><i class="fa fa-eye" style="font-size: 13px;height: 20px;top: 2px;right: 3px;">View</i></a>  
            <a class="btn btn-primary btn-md center-block" style="width: 90px; margin-right: 6%;border-style: none;background: #B35E08;height: 100%;" href="taskfeedback.php?edit=<?php echo $row['taskId'];?>"><i class="fa fa-pencil-square-o" style="font-size: 13px;height: 20px;top: 2px;right: 8px;">Responded<br>Feedback</i></a>
            </div></div>  
             </td> 
            </tr> 
            <?php }?>         
