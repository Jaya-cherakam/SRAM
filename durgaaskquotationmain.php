...
<br><br><br><br>
      ...
      <div class="row">
       <div class="col-lg-6">
          <img src="images/sramlogo1.png" style="width: 30%;margin-left: 20%;margin-top: 10%; border-radius: 50px;">
        </div>
...
$result=mysqli_query($con,"SELECT DISTINCT vehicleType FROM vehicleModels WHERE vehicleType!='' and productType='durgamahalakshmi'");
?>
      ...
      <div class="col-lg-6">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <option role="button" data-toggle="modal" value="subsidysale">subsidy sale</option>
            </select>
          </div>
          <button type="submit" name="durgaaskquotation" class="btn btn-default">Submit</button>
        </form></div></div></div>
