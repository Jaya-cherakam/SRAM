            ...
            <div class="col-md-7p0">
                <div class="collapse navbar-collapse" id="min_navbar">
                   <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php }else{?>
                            <li class="dropdown submenu">
                        <a href="contact.html" class="dropdown-toggle" data-toggle="dropdown" style="color: orange;">Login</a>    
                            <ul class="dropdown-menu">
      ...
      <div class="full-screen-container">
        <div class="login-container" style="border-radius: 5%;width: 400px;">
          ...
          <form action="server.php" method="POST">
            <div class="input-group">
              <input type="text" style="color:white;font-weight: bold;" placeholder="Username:" name="username" required="required">
            </div><br>
            <div class="input-group">
              <input type="text" style="color:white;font-weight: bold;" placeholder="Phone:" name="phone" required="required" maxlength="10" pattern="[6-9]{1}[0-9]{9}">
            </div><br>
            <button type="submit" name="customer_login" class="login-button">Login</button>
          </form>
        </div>
      </div>
    </body>
